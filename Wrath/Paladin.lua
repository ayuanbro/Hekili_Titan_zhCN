...
spec:RegisterHook( "reset_precast", function()
    if not aura_assigned then
        class.abilityList.assigned_aura = "|cff00ccff[指定光环]|r"
    ...
    if not blessing_assigned then
        class.abilityList.assigned_blessing = "|cff00ccff[指定祝福]|r"
...
--        toggle = "cooldowns",  修改 by 风雪20250422 神圣恳求不加入主要爆发组
...
spec:RegisterSetting("paladin_description", nil, {
    type = "description",
    name = "根据你的游戏风格偏好调整以下设置，始终建议你使用模拟器来为你的特定角色确定这些设置的最佳值。"
})
...
-- 新增 by 风雪20250422
spec:RegisterSetting("consecration_threshold", 40, {
    type = "range",
    name = "奉献阈值",
    desc = "选择使用奉献的最低法力值百分比",
    width = "full",
    min = 0,
    max = 100,
    step = 1,
    set = function( _, val )
        Hekili.DB.profile.specs[ 2 ].settings.consecration_threshold = val
    end
})
-- 新增结束
...
spec:RegisterSetting("primary_slack", 0.5, {
    type = "range",
    name = "主技能延迟（秒）",
    desc = "在使用驱邪、奉献、神圣愤怒、圣闪技能之前，给主技能额外的CD时间。",
    width = "full",
    min = 0,
    softMax = 2,
    step = 0.1,
...
spec:RegisterSetting("hor_macros", true, { --修改 by 风雪20250422 默认为主要伤害技能绑定清算之手
    type = "toggle",
    name = "使用清算之手宏",
    desc = "使用清算之手的宏，主要伤害技能均绑定清算之手（显示框架中不显示清算之手）",
    width = "single",
    set = function( _, val )
...
spec:RegisterSetting("highroll", true, {
    type = "toggle",
    name = "神圣风暴优先(2T10)",
    desc = "使神圣风暴(2T10) 优先级更高，潜在伤害更高，但平均伤害可能更低", --修改 by 风雪20250422
    width = "single",
    set = function( _, val )
...
spec:RegisterSetting("fol_on_aow", false, {
    type = "toggle",
    name = "战争艺术高亮(提示圣闪)",
    desc = "启用在奉献CD时,高亮提示战争艺术,提示瞬时圣闪。", --修改 by 风雪20250422
    width = "single",
    set = function( _, val )
...
spec:RegisterSetting("max_wait_for_six", 0.3, {
    type = "range",
    name = "6秒CD技能最大等待时间",
    desc = "等待6秒CD技能(正义之锤、正义盾击)的最大延迟时间,单位为秒。默认值: 0.3", --修改 by 风雪20250504
    width = "full",
    min = 0,
    softMax = 1,
    step = 0.05,
...
spec:RegisterSetting("min_six_delay", 2.7, {
    type = "range",
    name = "6秒CD技能最小间隔时间",
    desc = "6秒CD技能(正义之锤、正义盾击)的最小间隔时间，单位为秒。默认值: 2.7", --修改 by 风雪20250504
    width = "full",
    min = 0,
    softMax = 6,
    step = 0.1,
...
--[[ --修改 by 风雪20250504 神圣愤怒做为打断类技能，由玩家自行决定施法时机
spec:RegisterSetting("squeeze_hw_in_bl", false, {
    type = "toggle",
    name = "在嗜血期间使用神圣愤怒",
...
spec:RegisterPackSelector( "protection", "守护(黑科研)", "|T135893:0|t 守护",
    "如果你在|T135893:0|t守护天赋中投入的点数多于其他天赋，将会为你自动选择该优先级。",
    function( tab1, tab2, tab3 )
        return tab2 > max( tab1, tab3 )
    end )

spec:RegisterPackSelector( "holy", "神圣", "|T135920:0|t 神圣",
...
spec:RegisterPackSelector( "retribution_pvp", nil, "|T135873:0|t 惩戒PVP",
    "PVP专用惩戒天赋优先级，适用于战场和竞技场。",
    function( tab1, tab2, tab3 )
        return false
    end )
